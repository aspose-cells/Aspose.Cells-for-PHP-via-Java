...
final class StyleModifyFlag {
	...
	const FONT_COLOR = 16;
	const FONT_DIRTY = 41;
	const FONT_EQUALIZE = 46;
	const FONT_FAMILY = 14;
	const FONT_ITALIC = 18;
	const FONT_KERNING = 45;
	const FONT_NAME = 13;
	const FONT_SCHEME = 40;
	const FONT_SCRIPT = 23;
	const FONT_SIZE = 12;
	const FONT_SPACING = 44;
	const FONT_SPELLING_ERROR = 42;
	const FONT_STRIKE = 20;
	const FONT_SUBSCRIPT = 21;
	const FONT_SUPERSCRIPT = 22;
	const FONT_U_FILL_TX = 43;
	...
	const PATTERN = 33;
	const PROTECTION_SETTINGS = 39;
	const RELATIVE_INDENT = 48;
